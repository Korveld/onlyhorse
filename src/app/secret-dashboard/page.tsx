...
import ContentTab from "@/app/secret-dashboard/content/ContentTab";
import StoreTab from "@/app/secret-dashboard/store/StoreTab";
import AnalyticsTab from "@/app/secret-dashboard/analytics/AnalyticsTab";
