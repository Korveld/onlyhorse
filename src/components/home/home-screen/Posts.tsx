...
import {getPostsAction} from "@/components/home/home-screen/actions";
...
const Posts: FC<IPosts> = ({ admin, isSubscribed }) => {
        ...
        <div className="mt-10 px-3">
          <div className="flex flex-col items-center space-y-3 w-full md:w-3/4 mx-auto">
            ...
            <p className="text-center">
              Stay tuned for more posts from <span className="text-primary font-semibold text-xl">OnlyHorse</span>. You can subscribe to access exclusive content when it's available.
            </p>
          </div>
        </div>
      )}
